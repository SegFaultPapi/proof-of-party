  ...
  return (
    <main className="min-h-screen pt-20 pb-10 px-5 max-w-md mx-auto" style={{ background: "#f8f5ff" }}>
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="font-bold text-xl" style={{ color: "#1a0f3c" }}>Confirmar Check-In</h1>
          <p className="text-xs" style={{ color: "#7c6bb5" }}>Firma la transaccion para registrarte</p>
        </div>
      </div>
      ...
      <div
        ...
        style={{ background: "#ffffff", border: "1px solid rgba(131,110,249,0.2)" }}
      >
        ...
        <h2 className="font-bold text-lg mb-3" style={{ color: "#1a0f3c" }}>{selectedEvent.name}</h2>
        <div className="flex flex-col gap-2.5">
          <div className="flex items-center gap-2.5 text-sm" style={{ color: "#7c6bb5" }}>
      ...
      >
        <div className="flex justify-between items-center">
          <span className="text-sm" style={{ color: "#7c6bb5" }}>Deposito simbolico</span>
          <span className="font-bold text-sm" style={{ color: "#1a0f3c" }}>0.001 MON</span>
        </div>
        <div className="flex justify-between items-center mt-2">
          <span className="text-sm" style={{ color: "#7c6bb5" }}>Red</span>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center py-8">
        <div className="relative mb-6">
          ...
          <div
            ...
            style={{ background: "#22c55e", borderColor: "#f8f5ff" }}
          >
        ...
        <h1 className="font-bold text-2xl mb-2">
          ...
          <span style={{ color: "#1a0f3c" }}>exitoso</span>
        </h1>
        <p className="text-sm text-balance mb-8 max-w-xs leading-relaxed" style={{ color: "#7c6bb5" }}>
          Tu participacion quedo registrada on-chain en{" "}
          <span className="font-semibold" style={{ color: "#1a0f3c" }}>{checkIn.eventName}</span>
        </p>
        ...
        >
          <p className="text-xs font-medium mb-2" style={{ color: "#7c6bb5" }}>Transaccion confirmada</p>
        ...
        <div
          ...
          style={{ background: "rgba(131,110,249,0.06)", border: "1px solid rgba(131,110,249,0.18)" }}
        >
          <p className="text-sm font-semibold mb-1" style={{ color: "#1a0f3c" }}>Vuelve manana</p>
